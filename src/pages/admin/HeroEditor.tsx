                                            ...
                                            <CardContent className="p-5 flex flex-col flex-1 relative z-10">
                                                ...
                                                <div className="flex-1 space-y-3">
                                                    <div className="space-y-1">
                                                        ...
                                                        <Input
                                                            value={tech.name}
                                                            className="bg-background/20 border-border/30 px-3 h-10 font-bold text-lg focus:border-primary/50 transition-all shadow-none placeholder:opacity-50 peer"
                                                            placeholder="e.g. React"
                                                            onChange={(e) => { const u = [...techs]; u[index].name = e.target.value; setTechs(u); }}
                                                        />
                                                        <div className="h-0.5 w-8 bg-primary/40 rounded-full mt-1 group-hover:w-full peer-focus:w-full peer-focus:bg-primary transition-all duration-500" />
                                                    </div>
